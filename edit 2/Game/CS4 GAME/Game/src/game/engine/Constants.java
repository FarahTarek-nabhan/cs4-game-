...
public final class Constants {
	...
	//Board constants: static so that they could be class level and public so it can be accessed 
	...
	private constants (); // so no one can create a new object with it "instantiated"s
